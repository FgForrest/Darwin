ALTER TABLE T_DB_AUTOUPDATE CONVERT TO CHARACTER SET UTF8 COLLATE UTF8_UNICODE_CI;
...
INSERT INTO T_DB_AUTOUPDATE_PATCH (componentName,patchName,processTime,detectedOn,finishedOn,platform) VALUE ('lib_db_autoupdate','patch_3.0.sql',0,'2016-06-28 00:00:00','2016-06-28 00:00:00','mysql');
INSERT INTO T_DB_AUTOUPDATE_PATCH (componentName,patchName,processTime,detectedOn,finishedOn,platform) VALUE ('lib_db_autoupdate','patch_1.1.sql',0,'2016-06-28 00:00:00','2016-06-28 00:00:00','mysql');
INSERT INTO T_DB_AUTOUPDATE_PATCH (componentName,patchName,processTime,detectedOn,finishedOn,platform) VALUE ('lib_db_autoupdate','create.sql',0,'2016-06-28 00:00:00','2016-06-28 00:00:00','mysql');
